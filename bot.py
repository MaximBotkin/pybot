...
name_list = ['Алиса', 'Александра', 'Алёна', 'Алина', 'Алла', 'Анастасия', 'Анжелика', 'Анна', 'Валентина', 'Валерия',
             'Вера', 'Вероника',
             'Виктория', 'Галина', 'Дарья', 'Диана', 'Ева', 'Ева', 'Евгения', 'Екатерина', 'Алёна', 'Елена',
             'Елизавета', 'Жанна', 'Инна',
             'Ирина', 'Карина', 'Кристина', 'Ксения', 'Лариса', 'Любовь', 'Людмила', 'Маргарита', 'Марина', 'Мария',
             'Мила', 'Милана',
             'Надежда', 'Наталья', 'Ника', 'Нина', 'Оксана', 'Олеся', 'Ольга', 'Полина', 'Руслана', 'Светлана', 'София',
             'Софья', 'Тамара',
             'Татьяна', 'Юлия', 'Яна', 'Александр', 'Алексей', 'Анатолий', 'Андрей', 'Антон', 'Аркадий', 'Арсений',
             'Артём', 'Артур', 'Борис',
             ...
             'Константин', 'Лев', 'Леонид',
             'Максим', 'Марк', 'Матвей', 'Михаил', 'Никита', 'Николай', 'Олег', 'Павел', 'Пётр', 'Роман', 'Руслан',
             'Сергей', 'Степан', 'Тимур',
             'Фёдор', 'Юрий', 'Ярослав']
